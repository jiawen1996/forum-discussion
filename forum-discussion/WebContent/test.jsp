...
String url = "jdbc:mysql://localhost:3306/db_sr03?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC"; // 数据库连接字符串，test为数据库名称
